Shader "Unlit/Additive ZTestOff Area Clip"
{
    Properties
    {
    ...
    { 
        ...
        Pass
        {
            ...
            half4 frag (v2f IN) : COLOR
            {
                ...
                bool inArea = IN.worldPos.x >= _Area.x && IN.worldPos.x <= _Area.z && IN.worldPos.y >= _Area.y && IN.worldPos.y <= _Area.w;
                return inArea? color_1 : fixed4(0,0,0,0);
            }
            ENDCG
        }
    }
